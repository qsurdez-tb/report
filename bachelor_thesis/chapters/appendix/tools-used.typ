...
- Claude Opus (Anthropic) : help with reformulation, structuring the text, and producing the diagrams.
- Claude Fable (Anthropic) : an AI coding assistant used as a pair-programming aid for the watermarking implementation, described below.
